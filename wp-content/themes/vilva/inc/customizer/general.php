...
function vilva_customize_register_general( $wp_customize ){
    ...
    $wp_customize->add_section(
        'notifi_bar_image_section',
        array(
            'title'    => __( 'Notification Bar Settings', 'vilva' ),
    ...
    $wp_customize->add_control(
        new Vilva_Note_Control( 
            ...
            'notifi_bar_text',
            array(
                'section'     => 'notifi_bar_image_section',
    ...
    $wp_customize->add_control(
        new Vilva_Radio_Image_Control(
            ...
            array(
                ...
                'choices'    => array(
                    'one' => get_template_directory_uri() . '/images/pro/notification-bar.png',
                ),
            )
        )
    );
    ...
    $wp_customize->add_section(
        'featured_posts_image_section',
        array(
            'title'    => __( 'Featured Posts Settings', 'vilva' ),
            'panel'    => 'general_settings',
            'priority' => 15,
        )
    );
    ...
    $wp_customize->add_control(
        new Vilva_Note_Control( 
            ...
            'featured_posts_text',
            array(
                'section'     => 'featured_posts_image_section',
                'description' => sprintf( __( '%1$sThis feature is available in Pro version.%2$s %3$sUpgrade to Pro%4$s ', 'vilva' ),'<div class="featured-pro"><span>', '</span>', '<a href="https://blossomthemes.com/wordpress-themes/vilva-pro/?utm_source=vilva&utm_medium=customizer&utm_campaign=upgrade_to_pro" target="_blank">', '</a></div>' ),
            )
        )
    );
    ...
    $wp_customize->add_control(
        new Vilva_Radio_Image_Control(
            ...
            array(
                ...
                'feat_class' => 'upg-to-pro',
                'choices'    => array(
                    'one' => get_template_directory_uri() . '/images/pro/featured-post-view.png',
                    'two' => get_template_directory_uri() . '/images/pro/featured-post.png',
                ),
            )
        )
    );

    /** Featured Posts Settings Ends */

    /** Popular Posts Settings */

    $wp_customize->add_section(
        'popular_posts_image_section',
        array(
            'title'    => __( 'Popular Posts Settings', 'vilva' ),
            'panel'    => 'general_settings',
            'priority' => 15,
        )
    );
    ...
    $wp_customize->add_control(
        new Vilva_Note_Control( 
            ...
            'popular_posts_text',
            array(
                'section'     => 'popular_posts_image_section',
                'description' => sprintf( __( '%1$sThis feature is available in Pro version.%2$s %3$sUpgrade to Pro%4$s ', 'vilva' ),'<div class="featured-pro"><span>', '</span>', '<a href="https://blossomthemes.com/wordpress-themes/vilva-pro/?utm_source=vilva&utm_medium=customizer&utm_campaign=upgrade_to_pro" target="_blank">', '</a></div>' ),
            )
        )
    );
    ...
    $wp_customize->add_control(
        new Vilva_Radio_Image_Control(
            ...
            array(
                ...
                'feat_class' => 'upg-to-pro',
                'choices'    => array(
                    'one' => get_template_directory_uri() . '/images/pro/popular-post-view.png',
                    'two' => get_template_directory_uri() . '/images/pro/popular-post-setting.png',
                ),
            )
        )
    );

    /** Popular Posts Settings Ends */
    ...
    /** Social Media Settings Ends */
     ...
     $wp_customize->add_section(
        'social_share_image_section',
        array(
            'title'    => __( 'Social Sharing', 'vilva' ),
            'panel'    => 'general_settings',
            'priority' => 35,
        )
    );
    ...
    $wp_customize->add_control(
        new Vilva_Note_Control( 
            ...
            'social_share_text',
            array(
                'section'     => 'social_share_image_section',
                'description' => sprintf( __( '%1$sThis feature is available in Pro version.%2$s %3$sUpgrade to Pro%4$s ', 'vilva' ),'<div class="featured-pro"><span>', '</span>', '<a href="https://blossomthemes.com/wordpress-themes/vilva-pro/?utm_source=vilva&utm_medium=customizer&utm_campaign=upgrade_to_pro" target="_blank">', '</a></div>' ),
            )
        )
    );
    ...
    $wp_customize->add_control(
        ...
        array(
            'section'         => 'instagram_settings',
            'label'           => __( 'Shortcode', 'vilva' ),
            'type'            => 'text',
            'description'     => __( 'Add shortcode for your instagram profile below:', 'vilva' ),
            'active_callback' => 'vilva_ed_instagram',
        )
    );
